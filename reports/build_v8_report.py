...
![Target Variable Distribution](../assets/v8%20plots/figure_001.png)
*Figure 1: Distribution of Target Variable Match Outcomes.*

![Categorical Feature Distributions](../assets/v8%20plots/figure_002.png)
*Figure 2: Categorical Feature Distributions Across 50,000 Profiles.*

![Numerical Feature Distributions](../assets/v8%20plots/figure_003.png)
*Figure 3: Numerical Feature Probability Density Distributions.*

![Outlier Detection via Boxplots](../assets/v8%20plots/figure_004.png)
*Figure 4: Outlier Detection Boxplots for Numerical App Engagement Metrics.*

![Numerical Features vs Target](../assets/v8%20plots/figure_005.png)
*Figure 5: Numerical Features Distributions Overlaid by Binary Target Class.*

![Categorical Features vs Target](../assets/v8%20plots/figure_006.png)
*Figure 6: Target Success Rates Across Nominal Categorical Variables.*

![Correlation Heatmap](../assets/v8%20plots/figure_007.png)
*Figure 7: Pearson Correlation Heatmap of Continuous Numerical Features.*

![Interest Tags Analysis](../assets/v8%20plots/figure_008.png)
...
![Causal Structure Discovery DAG](../assets/v8%20plots/figure_009.png)
*Figure 9: Directed Acyclic Graph (DAG) Recovered via PC Algorithm.*

![Causal Adjacency Heatmap](../assets/v8%20plots/figure_010.png)
...
![DML Residual Distributions](../assets/v8%20plots/figure_011.png)
*Figure 11: DML Residual Distributions.*

![DML ATE Confidence Intervals](../assets/v8%20plots/figure_012.png)
...
![Isolation Forest OOD Anomaly Scores](../assets/v8%20plots/figure_013.png)
*Figure 13: Isolation Forest Anomaly Score Distribution.*

**4.4 Feature Selection & PCA**

![ANOVA F-Score](../assets/v8%20plots/figure_014.png)
*Figure 14: Univariate ANOVA F-Score Feature Selection Rankings.*

![Mutual Information](../assets/v8%20plots/figure_015.png)
*Figure 15: Mutual Information Dependency Scores.*

![PCA Explained Variance](../assets/v8%20plots/figure_016.png)
*Figure 16: PCA Explained Variance.*

![PCA Biplot](../assets/v8%20plots/figure_017.png)
...
![Label Smoothing curves](../assets/v8%20plots/figure_018.png)
*Figure 18: Label Smoothing and Mixup Convergence Curves.*

![Confusion Matrices](../assets/v8%20plots/figure_019.png)
*Figure 19: Confusion Matrices across selected models.*

![ROC Curves](../assets/v8%20plots/figure_020.png)
*Figure 20: Receiver Operating Characteristic (ROC) Curves.*

![Precision-Recall Curves](../assets/v8%20plots/figure_021.png)
*Figure 21: Precision-Recall Curves for Optimal Thresholding.*

![Friedman Statistical Test Boxplots](../assets/v8%20plots/figure_022.png)
*Figure 22: Friedman Statistical Test comparing CV score stability.*

![Learning Curves](../assets/v8%20plots/figure_023.png)
...
![Opacus DP loss curves](../assets/v8%20plots/figure_024.png)
*Figure 24: DP-SGD Training Loss under Opacus Privacy.*

**6.2 Custom PyTorch Architectures**

![Attentive Tabular Network Mask Heatmap](../assets/v8%20plots/figure_025.png)
*Figure 25: TabNet-style Attentive Selection Mask Heatmap.*

![GNN User-Similarity Graph topology](../assets/v8%20plots/figure_026.png)
*Figure 26: Semi-supervised Graph Attention Network (GAT) Topology.*

**6.3 Self-Supervised SCARF & Zero-Shot TabPFN**

![SCARF Contrastive Pre-Training Loss](../assets/v8%20plots/figure_027.png)
*Figure 27: SCARF Contrastive Pre-Training Loss.*

![SCARF Embeddings t-SNE](../assets/v8%20plots/figure_028.png)
*Figure 28: SCARF Pre-trained Embeddings t-SNE Projection.*

![TabPFN Zero-Shot Decision Boundaries](../assets/v8%20plots/figure_029.png)
...
![Optuna Pareto Frontier](../assets/v8%20plots/figure_030.png)
*Figure 30: Multi-Objective GPU Optuna Pareto Frontier.*

![Demographic Parity](../assets/v8%20plots/figure_031.png)
*Figure 31: Demographic Parity Audit for Ethical Fairness.*

![Permutation Feature Interaction](../assets/v8%20plots/figure_032.png)
*Figure 32: Friedman's H-Statistic for Pairwise Synergies.*

![SHAP Interaction Values](../assets/v8%20plots/figure_033.png)
*Figure 33: SHAP Interaction Values (Beeswarm).*

![SHAP Dependence](../assets/v8%20plots/figure_034.png)
...
![MAPIE Conformal Prediction Bounds](../assets/v8%20plots/figure_035.png)
*Figure 35: MAPIE Conformal Prediction Bounding Sets (Leakage Fixed).*

![Adversarial Robustness Accuracy Drop](../assets/v8%20plots/figure_036.png)
*Figure 36: Model Accuracy Decay under Adversarial FGSM Attack.*

![Model Calibration Reliability Diagram](../assets/v8%20plots/figure_037.png)
*Figure 37: Isotonic Probability Calibration Reliability Diagram.*

![Causal Uplift Persuadables Quadrant](../assets/v8%20plots/figure_038.png)
...
with open(r"c:\Users\HP\Documents\GitHub\ML-dating-app-behaviour\reports\WIA1006_Assignment_Report_V8.md", "w", encoding="utf-8") as f:
    f.write(md_content)
