...
print("Injecting MAPIE 1.4.0+ compatibility and SplitConformalClassifier fallback into V4 notebook...")

mapie_source = """import os
...
for i, alpha in enumerate(alpha_levels):
    coverage = np.mean(classification_coverage_score(y_test, y_sets[:, :, i]))
...
nb['cells'][146]['source'] = [line + '\n' for line in mapie_source.split('\n')]

with open(notebook_path, 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)

print("SUCCESS: V4 MAPIE cell successfully updated with full backwards and forwards compatibility!")
