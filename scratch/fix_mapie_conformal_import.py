...
print("Injecting MAPIE 1.4.0+ compatibility and SplitConformalClassifier fallback...")
...
nb['cells'][157]['source'] = [line + '\n' for line in mapie_source.split('\n')]

with open(notebook_path, 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)

print("SUCCESS: MAPIE cell successfully updated with full backwards and forwards compatibility!")
