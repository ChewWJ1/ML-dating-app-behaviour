...
st.set_page_config(page_title="Documentation | SwipeIQ", page_icon="📄", layout="wide")
theme.inject_css()
...
with tab1:
    ...
    pdf_path = os.path.join(ROOT_DIR, "WIA1006 Machine Learning - Tying the Data Knot Assignment Report.pdf")
...
with tab2:
    ...
    st.markdown("Read-only rendering of the `ML_dating_app_behaviour.ipynb` source file.")
    ipynb_path = os.path.join(ROOT_DIR, "ML_dating_app_behaviour.ipynb")
